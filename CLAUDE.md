...
10. `/api/puzzles.js` - Puzzle fetching (with Redis caching) + **Practice Mode** (?mode=practice&variant=classic|x-sudoku|mini|anti-knight|killer-sudoku|hyper-sudoku|consecutive-sudoku|thermo-sudoku) *[Phase 1 Month 4-5, Phase 2 Month 9-13]*
...
- **Phase 2 Month 11**: 12 endpoints (✅ **STILL AT LIMIT**)
...
- **Consolidation History**:
  ...
  - Phase 2 Month 11: Added Hyper Sudoku variant to `/api/puzzles.js?mode=practice&variant=hyper-sudoku`
