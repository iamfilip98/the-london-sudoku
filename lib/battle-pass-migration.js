...
async function migrateBattlePass() {
  ...
  try {
    ...
    console.log('Battle pass migration completed successfully!');
    return { success: true };
  } catch (error) {
...
async function createBattlePassTables() {
  console.log('Creating battle pass tables...');
  ...
  console.log('All battle pass tables created successfully!');
}
...
async function seedSeason1() {
  console.log('Seeding Season 1 data...');
  ...
  console.log(`Season 1 created with ID: ${seasonId}`);
