...
async function migrateLeagueSeasonTracking() {
    ...
    try {
        ...
        console.log('Adding enhanced tracking columns to league_season_results...');
        ...
        console.log('Creating index for rank percentile queries...');
        ...
        console.log('Backfilling rank percentile for existing records...');
        ...
        console.log('Backfilling winning margin for first-place finishes...');
        ...
        console.log('Setting max possible points for existing records...');
        ...
        console.log('League season tracking migration completed successfully!');
        return {
            success: true,
        ...
        console.error('League season tracking migration failed:', error);
        throw error;
    } finally {
        client.release();
    }
