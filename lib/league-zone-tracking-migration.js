...
async function migrateLeagueZoneTracking() {
    ...
    try {
        ...
        console.log('Creating league_position_snapshots table...');
        ...
        console.log('Creating indexes for zone tracking...');
        ...
        console.log('League zone tracking migration completed successfully!');
        return {
            success: true,
        ...
        console.error('League zone tracking migration failed:', error);
        throw error;
    } finally {
        client.release();
    }
