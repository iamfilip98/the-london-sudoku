...
async function getOfficialLeagues() {
  try {
    ...
    console.error('Failed to get official leagues:', error);
...
async function getUserLeagueStatus(userId) {
  try {
    ...
    console.error('Failed to get user league status:', error);
...
async function awardLeaguePoints(userId, points) {
  try {
    ...
    console.error('Failed to award league points:', error);
...
async function updateLeagueRanks(client, leagueId) {
  ...
  try {
    ...
    console.error('Failed to update league ranks:', error);
    throw error;
  }
}
...
async function getCustomLeagues(userId) {
  try {
    ...
    console.error('Failed to get custom leagues:', error);
