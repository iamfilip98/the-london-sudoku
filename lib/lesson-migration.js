...
async function migrateLessons() {
  console.log('Starting lesson system migration...');
  ...
  try {
    ...
    console.log('Lesson system migration completed successfully!');
    return { success: true };
  } catch (error) {
...
async function createLessonTables() {
  ...
  console.log('All lesson system tables created successfully!');
}
...
async function seedLessonAchievements() {
  console.log('Seeding lesson achievements...');
  ...
  console.log(`Seeded ${achievements.length} lesson achievements!`);
}
...
async function createLessonTriggers() {
  console.log('Creating lesson triggers and functions...');
  ...
  console.log('All lesson triggers and functions created successfully!');
}
