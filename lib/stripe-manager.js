...
async function createCheckoutSession(username, email) {
    try {
        ...
        if (!customerId) {
            ...
            console.log(`✅ Created Stripe customer: ${customerId} for ${username}`);
        }
        ...
        console.log(`✅ Created checkout session: ${session.id} for ${username}`);
...
async function handleCheckoutCompleted(session) {
    ...
    console.log(`✅ Checkout completed for ${username}`);
...
async function handleSubscriptionCreated(subscription) {
    ...
    console.log(`✅ Subscription created for ${username}: ${subscriptionId}`);
}
