 ...
 * @param {string} player - Player name/username to validate
...
function validatePlayer(player) {
  ...
  // Accept any valid username (validation handled by Clerk/authentication layer)
  if (player.length < 1 || player.length > 50) {
    throw new Error('Player must be between 1 and 50 characters');
  }
